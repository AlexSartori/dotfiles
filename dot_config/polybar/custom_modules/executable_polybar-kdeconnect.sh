...
COLOR_BATTERY_90='#0f0'         # Battery >= 90
COLOR_BATTERY_80='#3f0'         # Battery >= 80
COLOR_BATTERY_70='#6f0'         # Battery >= 70
COLOR_BATTERY_60='#af0'         # Battery >= 60
COLOR_BATTERY_50='#ff0'         # Battery >= 50
COLOR_BATTERY_LOW='#fa0'        # Battery <  50
